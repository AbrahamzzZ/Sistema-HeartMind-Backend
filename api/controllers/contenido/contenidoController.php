...
require_once __DIR__ . '/../../services/contenido/cloudinaryService.php';
...
class ContenidoController
{
    ...
    public function obtenerContenidos(): void
    {
        ...
        echo json_encode($this->service->obtenerContenidos());
    }

    public function obtenerContenido(int $id): void {
        header(self::CONTENT_TYPE_JSON);
    ...
    public function actualizarContenido(): void {
        ...
        try {
            ...
            $contenido = new Contenido($datos);
            $existente = $this->service->obtenerContenido((int) $contenido->id);
    ...
    public function eliminarContenido(int $id): void {
